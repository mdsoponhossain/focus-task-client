    ...
    return (
        <div className=" py-12 from-indigo-500  via-purple-500 to-pink-500 ">
            <div className="bg-gradient-to-r w-full pb-20 ">
                ...
                <div className="flex-col  md:flex justify-between h-fit md:h-[360px]  md:w-[800px] mx-auto">
                    <div className="h-[400px] mt-7 md:mt-0 md:rounded-xl bg-white text-black p-3 w-full md:w-[300px]  border-4">
                    ...
                    <div className="h-[400px] md:rounded-xl mt-7 md:mt-0 bg-white text-black p-3 w-full md:w-[300px] border-4">
                ...
                <div className=" md:rounded-xl h-[400px] bg-white text-black p-3 w-full  md:-mt-[400px] lg:ml-[500px] sticky md:w-[300px] flex-grow   border-4 mt-7">
