    ...
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <aside>
                    <img className="w-16 h-12 " src="https://i.ibb.co/MC6kDhR/task-management-removebg-preview.png" alt="" />
                    <p>FocusTask.com<br />Providing reliable task management since 2023</p>
                </aside>
                <nav>
